...
//a nuGet package that was recommended
using NCalc;
    ...
    namespace NumericalMethods
    {
        public partial class Form1 : Form
        {
            public Form1()
            {
                ...
                guna2DataGridView1.Columns.Add("X", "X");
                guna2DataGridView1.Columns.Add("f(x)", "f(x)");
            ...
            private void btnCalculate_Click(object sender, EventArgs e)
            {
                ...
                //this will replace all trigonometric function that the user inputted into a syntax that the c# or the nuGet package NCalc can read or process
                ...
                //this is a function that will read the equation or function that the user inputted, and also that will fit NCalc
                ...
                do
                {
                    //calls the function above and passing x0 and x1 as parameters then directly assigning it to f0 and f1
                    f0 = f(x0);
                    f1 = f(x1);
                    ...
                    guna2DataGridView1.Rows.Add(iteration + 1, x2.ToString("F4"), f2.ToString("F4"), error.ToString("F2"));
                    iteration++;
                    ...
                    if (error < tolerance)
                    {
                        ...
                        //then set the visibility of the label to true, then it will replace the value of the final root
